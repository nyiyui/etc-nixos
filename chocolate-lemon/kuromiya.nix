...
in
{
  ...
  qrystal.services.cs = {
    ...
    config.tokens = [
      (token {
        ...
        hash = "qrystalcth_d40ec13487018cd0976ec5701301cf6abe3c7021d3dc495b8faa470044315edb";
      })
      (token {
        name = "hinanawi";
      ...
      (token {
        name = "mitsu8";
        hash = "qrystalcth_c8f7c45f3af3ddd98da52f9082301242c5725f86877c2c27e27365a2a91188c3";
      })
      (token {
        name = "flan";
        hash = "qrystalcth_660427dd2c67e4936a22f7bd3e23e96a71f1b65ec2d89a85f3364e60f4909774";
      })
      (token {
        name = "sawako";
        hash = "qrystalcth_9d660067ed0dde4ba2707a40cf60bf2d2ec8792092353e4a82b2eb03cb3ae80d";
      })
      # (token { # TODO: not working rn
      ...
      (token {
        name = "chikusa";
        hash = "qrystalcth_c192f889d3ec3bc880dfa3d15aa4fb59616ad37d6c1337499a46bb479a86a8f8";
      })
    ];
  ...
  networking.firewall.allowedUDPPorts = [
    39252
    config.qrystal.services.cs.config.central.networks.msb.listenPort
  ];
