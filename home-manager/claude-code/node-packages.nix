...
in {
  "@anthropic-ai/claude-code" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/@anthropic-ai/claude-code/-/claude-code-0.2.117.tgz";
      sha512 =
        "0mJr2n7bxoBLpxT7DjhOXkVK7lZB3ML5uUAhC3pny/IipF6Q+05XPO2UNoaNLB/9yhXSUmu0cNwmHz6m1e2Oqw==";
    };
