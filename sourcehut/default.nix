  ...
  commonServiceSettings = srv: {
    ...
    api-origin = mkOption {
      ...
      defaultText = lib.literalMD ''
        `"http://''${`[](#opt-kiyurica.sourcehut.listenAddress)`}:''${toString (`[](#opt-kiyurica.sourcehut.${srv}.port)` + 100)}"`
      '';
    };
  };
        ...
        options."git.sr.ht::api" = {
          internal-ipnet = mkOption {
            description = ''
              ...
              See [](#opt-kiyurica.sourcehut.listenAddress).
            '';
  ...
  imports = [
    ...
    (import ./service.nix "lists" (
      ...
      in
      {
        ...
        extraConfig = mkIf cfg.postfix.enable {
          ...
          kiyurica.sourcehut.settings."lists.sr.ht::mail".sock-group = postfix.group;
          services.postfix = {
    ...
    (import ./service.nix "todo" {
      ...
      extraConfig = mkIf cfg.postfix.enable {
        ...
        kiyurica.sourcehut.settings."todo.sr.ht::mail".sock-group = postfix.group;
        services.postfix = {
