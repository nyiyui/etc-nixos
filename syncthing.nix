{
  services.syncthing = {
    ...
    devices = {
      "miyo".id = "M7X7VPF-QU4SBMZ-3EBZT2T-IAARHKV-FL7J2CV-DLUKDZ6-QCUX727-RLHHYAC";
      "asuna".id = "Q5BN7WM-NFZG7XU-4Y266W3-OSAR4VJ-WI3GQOG-56Q54AR-X5XYMTL-RHSZTQJ";
      "makura".id = "Y3IYLHZ-SUS5JCX-QQENQUL-PI4XK7E-CPWJT3P-MVJGZVS-4XIM4HB-N4UNFAU";
      "x1".id = "KKFQLLW-KWKGN3M-EIWQUL5-4DBNSB5-VAE6X7W-XXPFNB2-E27QFLO-DPLX3QV";
    };
    folders = {
      "inaba" = {
        id = "pugdv-kmejz";
